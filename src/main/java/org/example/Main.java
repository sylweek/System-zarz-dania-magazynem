...
public class Main {
    public static void main(String[] args) throws UsuwanieLiniiException {
        ...
        //pojazdRolniczyService.wyszukajPojazdPoNazwie("Zetor");
        ...
        //pojazdCiezarowyService.wyszukajPojazdPoNazwie("Man");
        ...
        //pojazdBudowalnyServices.wyszukajPojazdPoNazwie("JCB");
        ...
        //autobusElektrycznyServices.wyszukajPojazdPoNazwie("MAN");
    }
}